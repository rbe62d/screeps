    ...
    function() {
        ...
        if(closestHostile != undefined) {
            ...
            let closestDamagedStructure = this.pos.findClosestByRange(FIND_STRUCTURES, {
                ...
                // filter: (structure) => structure.hits < structure.hitsMax && structure.structureType != STRUCTURE_WALL && structure.structureType != STRUCTURE_RAMPART && structure.structureType != STRUCTURE_CONTAINER
            });
